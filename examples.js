...
// Redeem HTLC
const htlc3 = createHTLC({
  recipientAddress,
  refundAddress,
})

// Normally I would have to send a payment to htlc3.htlcAddress and get the TXID, value, and vout of the HTLC. I'm gonna dummy those values here. 
const TXID = "2d35ca1a04dafc84abedb25577fcf45c9b1cf278e569940b1621b5060dd36d62"
const value = 1e8
const vout = 1
const redeemTxRaw = redeemHTLC({
  preimage: htlc3.preimage,
  recipientWIF: recipientKeypair.toWIF(),
  witnessScript: htlc3.witnessScript,
  txHash: TXID,
  value,
  feeRate: 10,
  vout
